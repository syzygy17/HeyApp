...
/*
    In this Activity, we show all registered users.

    В этой Активности мы показываем всех зарегистрированных пользователей.
*/
...
public class FindFriendsActivity extends AppCompatActivity {
    ...
    /*
        We take data from Firebase and fill in the RecyclerView.
    */
    @Override
